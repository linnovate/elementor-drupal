...
<script type="text/template" id="tmpl-elementor-panel-history-page">
	<div id="elementor-panel-elements-navigation" class="elementor-panel-navigation">
		<div id="elementor-panel-elements-navigation-history" class="elementor-panel-navigation-tab elementor-active" data-view="history"><?php echo ___elementor_adapter( 'Actions', 'elementor' ); ?></div>
		<div id="elementor-panel-elements-navigation-revisions" class="elementor-panel-navigation-tab" data-view="revisions"><?php echo ___elementor_adapter( 'Revisions', 'elementor' ); ?></div>
	</div>
...
<script type="text/template" id="tmpl-elementor-panel-history-tab">
	<div class="elementor-panel-box">
		<div class="elementor-panel-box-content">
			...
			<div class="elementor-history-revisions-message"><?php echo ___elementor_adapter( 'Switch to Revisions tab for older versions', 'elementor' ); ?></div>
		</div>
	</div>
</script>
