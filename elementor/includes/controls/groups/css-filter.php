...
class Group_Control_Css_Filter extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['blur'] = [
			'label' => _x_elementor_adapter( 'Blur', 'Filter Control', 'elementor' ),
		...
		$controls['brightness'] = [
			'label' => _x_elementor_adapter( 'Brightness', 'Filter Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['contrast'] = [
			'label' => _x_elementor_adapter( 'Contrast', 'Filter Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['saturate'] = [
			'label' => _x_elementor_adapter( 'Saturation', 'Filter Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
		...
		$controls['hue'] = [
			'label' => _x_elementor_adapter( 'Hue', 'Filter Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'render_type' => 'ui',
			'required' => 'true',
			'default' => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x_elementor_adapter( 'CSS Filters', 'Filter Control', 'elementor' ),
			],
		];
	}
}
