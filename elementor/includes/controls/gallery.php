			...
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-media elementor-control-tag-area">
					<div class="elementor-control-gallery-status">
						...
						<span class="elementor-control-gallery-clear">(<?php echo ___elementor_adapter( 'Clear', 'elementor' ); ?>)</span>
					</div>
					<div class="elementor-control-gallery-thumbnails"></div>
					<button class="elementor-button elementor-control-gallery-add"><?php echo ___elementor_adapter( 'Add Images', 'elementor' ); ?></button>
				</div>
			</div>
		</div>
		<?php
