...
class Control_URL extends Control_Base_Multiple {
	...
	protected function get_default_settings() {
		return [
			'label_block' => true,
			'show_external' => true,
			'placeholder' => ___elementor_adapter( 'Paste URL or type', 'elementor' ),
			'dynamic' => [
	...
	public function content_template() {
		...
		<div class="elementor-control-field elementor-control-url-external-{{{ data.show_external ? 'show' : 'hide' }}}">
			...
			<div class="elementor-control-input-wrapper">
				...
				<input id="_ajax_linking_nonce" type="hidden" value="<?php echo wp_create_nonce_elementor_adapter( 'internal-linking' ); ?>" />
