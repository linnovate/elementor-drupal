...
<script type="text/template" id="tmpl-elementor-navigator">
	<div id="elementor-navigator__header">
		...
		<div id="elementor-navigator__header__title"><?php echo ___elementor_adapter( 'Navigator', 'elementor' ); ?></div>
...
<script type="text/template" id="tmpl-elementor-navigator__elements--empty">
	<div class="elementor-empty-view__title"><?php echo ___elementor_adapter( 'Empty', 'elementor' ); ?></div>
</script>
...
<script type="text/template" id="tmpl-elementor-navigator__root--empty">
	...
	<div class="elementor-nerd-box-title"><?php echo ___elementor_adapter( 'Easy Navigation is Here!', 'elementor' ); ?></div>
	<div class="elementor-nerd-box-message"><?php echo ___elementor_adapter( 'Once you start filling your page with content, this is where you\'ll be able to quickly move elements around the page. This feature is extremely handy, especially for managing long-form content.', 'elementor' ); ?></div>
</script>
