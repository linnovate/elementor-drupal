...
<script type="text/template" id="tmpl-elementor-panel-categories">
	...
	<div id="elementor-panel-get-pro-elements" class="elementor-panel-nerd-box">
		...
		<div class="elementor-panel-nerd-box-message"><?php echo ___elementor_adapter( 'Get more with Elementor Pro', 'elementor' ); ?></div>
		<a class="elementor-button elementor-button-default elementor-panel-nerd-box-link" target="_blank" href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=panel-widgets&utm_campaign=gopro&utm_medium=wp-dash' ); ?>"><?php echo ___elementor_adapter( 'Go Pro', 'elementor' ); ?></a>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-panel-global">
	<div class="elementor-panel-nerd-box">
		<i class="elementor-panel-nerd-box-icon eicon-hypster" aria-hidden="true"></i>
		<div class="elementor-panel-nerd-box-title"><?php echo ___elementor_adapter( 'Meet Our Global Widget', 'elementor' ); ?></div>
		<div class="elementor-panel-nerd-box-message"><?php echo ___elementor_adapter( 'With this feature, you can save a widget as global, then add it to multiple areas. All areas will be editable from one single place.', 'elementor' ); ?></div>
		<div class="elementor-panel-nerd-box-message"><?php echo ___elementor_adapter( 'This feature is only available on Elementor Pro.', 'elementor' ); ?></div>
		<a class="elementor-button elementor-button-default elementor-panel-nerd-box-link" target="_blank" href="<?php echo Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=panel-global&utm_campaign=gopro&utm_medium=wp-dash' ); ?>"><?php echo ___elementor_adapter( 'Go Pro', 'elementor' ); ?></a>
	</div>
</script>
