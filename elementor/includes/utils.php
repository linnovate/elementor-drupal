...
class Utils {
	...
	public static function is_post_support( $post_id = 0 ) {
		 ...
		 * @param string $post_type Post type.
		 */
		$is_supported = apply_filters_elementor_adapter( 'elementor/utils/is_post_support', $is_supported, $post_id, $post_type );
	...
	public static function is_post_type_support( $post_type ) {
		if ( ! post_type_exists_elementor_adapter( $post_type ) ) {
			return false;
		}
