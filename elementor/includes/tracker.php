			...
			<div class="elementor-message-inner">
				...
				<div class="elementor-message-content">
					...
					<p class="elementor-message-actions">
						<a href="<?php echo $optin_url; ?>" class="button button-primary"><?php echo ___elementor_adapter( 'Sure! I\'d love to help', 'elementor' ); ?></a>&nbsp;<a href="<?php echo $optout_url; ?>" class="button-secondary"><?php echo ___elementor_adapter( 'No thanks', 'elementor' ); ?></a>
					</p>
				</div>
			</div>
		</div>
